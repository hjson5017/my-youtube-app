...
st.caption("유튜브 영상 링크를 넣으면, 좋아요가 많은 순으로 댓글을 최대 100개 가져오고 자주 나온 단어를 분석합니다.")
...
if not filtered_words:
    ...
    # Counter로 단어별 등장 횟수를 세고, 가장 많이 나온 20개만 추림
    ...
    st.plotly_chart(fig, use_container_width=True)# -*- coding: utf-8 -*-
"""
유튜브 댓글 분석 앱 - 2단계
- 유튜브 영상 링크를 입력하면, YouTube Data API v3로 댓글을 최대 100개 가져옵니다.
- 좋아요가 많은 순(order=relevance)으로 요청해서, 좋아요 많은 순으로 정렬해 보여줍니다.
